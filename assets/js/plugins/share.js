        ...
        init: function(){
            ...
            this.scope.on("click", options.buttons, function(e){
                ...
                if (attr){
            		...
            		if (attr == "fb") _this.fb(url, title);
            		else if (attr == "vk") _this.vk(url, title);
            		else if (attr == "gl") _this.gl(url, title);
            		else if (attr == "dk") _this.dk(url, title);
            		else if (attr == "tw") _this.tw(url, title);
                }
            });
